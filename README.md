...
**Commercial use of the curriculum — including paid facilitator training, paid cohorts, and licensing to employers — requires a separate commercial license.** See the [facilitator pathway](https://camp-claude.github.io/facilitate) or email `facilitators@campclaude.ai`.
